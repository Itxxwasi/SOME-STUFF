...
smd({
  ...
  try {
    try {
      ...
      if (!_0x557719) {
        return man.reply("Provide me a query ex Who isWASI-MD-V2");
      }
...
smd({
  ...
  try {
    ...
    if (!_0x1b0897) {
      return _0x42b3b8.reply("Provide me a query ex Who isWASI-MD-V2");
    }
...
smd({
  ...
  use: "923192173xx,Your_text_here",
  fromMe: true,
  filename: __filename
