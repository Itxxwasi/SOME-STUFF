...
smd(
 ...
 smd({
   ...
   try {
     ...
     try {
       let {
         key: _0x2d7cf6
       } = await _0x4e7c63.send("Counting... 0", {}, "WASIMDV2", _0x4e7c63);
 ...
 let tmpUrl = "https://telegra.ph/file/057b3ccce5c8efa2c7dc7.jpg";
 const secmailData = {};
 smd({
   pattern: "tempmail",
