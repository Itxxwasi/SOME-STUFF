...
`;
 ...
 smd({
   ...
   try {
     ...
     if (!_0x204f81) {
       return _0x55aba2.reply("*_Example : .tts Hi,I am WASI-MD-V2 whatsapp bot._*");
     }
     try {
 ...
 smd({
   ...
   try {
     ...
     let _0x4737bb = {
       audio: _0x2ba501,
       fileName: "WASI-MD-V2 tiktok Sound" + _0x19c223 + ".m4a",
       mimetype: "audio/mpeg",
       ptt: true,
 ...
 smd({
   ...
   try {
     ...
     try {
       ...
       let _0x4b47c3 = "./temp/WASI-MD-V2 " + _0x1d542b[1] + ".mp3";
     ...
     let _0x300d1a = {
       ...
       mimetype: "audio/mpeg",
       fileName: "WASI-MD-V2--" + _0x1d542b[1] + ".mp3",
       caption: Config.caption,
