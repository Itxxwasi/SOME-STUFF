      ...
      if (_0xf00650 === _0x242f00(243)) {
        _0x2d78d9 = await (
          await axios[_0x242f00(266)](
            _0x242f00(244) +
              _0x109acf[_0x242f00(258)][_0x242f00(92)]("@")[0] +
              _0x242f00(233) +
              _0x2728a0 +
              "]"
          )
  ...
  smd(
    ...
    async (message, input) => {
      try {
        ...
        return await message.send(`*wasiʙᴀʀᴅ ᴀɪ:*\n ${result}`, { quoted: message });
      } catch (error) {
        ...
        if (!_0xd9b857.includes("x")) {
          return _0x165087.send(
            "*You did not add x in number.*\n*Ex: " +
              prefix +
              "advt 92803xx,Your_Message_here*  \n " +
              Config.caption
          );
        }
